    ...
    <div className="report-page print-break flex flex-col">
      <div className="flex-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-4">
          ...
          <div className="info-card p-3">
            <p className="text-xs text-muted-foreground mb-1">Rotação</p>
          ...
          <div className="info-card p-3">
            <p className="text-xs text-muted-foreground mb-1">Rolamento</p>
        ...
        {/* Images - Equipment, Trend, and Spectrum */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4 print:grid-cols-3 print:gap-4 print:mb-3">
          <div className="vibration-card flex flex-col items-center">
            {equipmentImage ? (
              <img 
                src={equipmentImage} 
                alt="Foto do Equipamento" 
                className="report-image h-[140px] object-contain w-full" 
              />
            ) : (
              <div className="image-placeholder h-[140px] w-full">
          ...
          <div className="vibration-card flex flex-col items-center">
            {trendImage ? (
              ...
              <div className="image-placeholder h-[140px] w-full flex items-center justify-center">
        ...
        <div className="feedback-section print:mt-2 print:pt-2 print:border-t print:border-border">
          <div className="mb-3 print:mb-2">
            ...
            <div className="mt-1 print:mt-1 h-12 print:h-8 border-b-2 border-dashed border-border"></div>
          </div>
